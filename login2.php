...
if(isset($_POST['myusername']) && isset($_POST['mypassword']))
{
	...
	$cb="SELECT * FROM client WHERE clientId='$usrnm' AND password='$pswd'";
	$result=mysqli_query($con,$cb) or die(mysqli_error($con));
...
<body>
  <div >
    ...
    <form name="form1" method="post" action="#">
     ...
     <a href="register2.php">New user?  Register here</a> </div >
</body>
